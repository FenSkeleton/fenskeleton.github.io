...
class Movies:
	...
	simkl_personal = ('simkl_plan_to_watch', 'simkl_completed', 'simkl_dropped')
	...
	def build_movie_content(self, _position, _id):
		try:
			...
			simkl_manager_params = self.build_url({'mode': 'simkl.simkl_list_manager', 'tmdb_id': tmdb_id, 'imdb_id': imdb_id, 'media_type': 'movie', 'title': title, 'year': year})
